  ...
  """
    if data_format :
        ...
        model = tf.keras.Sequential([
            l.Reshape(target_shape=input_shape, input_shape=(28 * 28, ),name='image'),
            l.Conv2D(32,
                    5,
                    padding='same',
                    data_format=data_format,
        ...
        l = tf.keras.layers
        a = l.Input(shape=(28*28,))
        b =  l.Reshape(target_shape=(28,28,1), input_shape=(28 * 28, ),name='image')(a)
    #    b = l.Conv2D(64,5, padding='same',activation=tf.nn.relu)(b)
        b = l.Flatten()(b)
        b = l.Dense(10)(b)
